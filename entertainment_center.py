...
Currently, the only objects that can be
added to the entertainment center are movies.
...
matrix = media.Movie("The Matrix",
                     ...
                     " overlords in a struggle to free the rest"
                     " of the human race from virtual bondage.",
...
fellowship_of_the_ring = media.Movie("The Fellowship of the Ring",
                                     "An enthralling adaptation of J.R.R." 
...
usual_suspects = media.Movie("The Usual Suspects",
                             "A crime thriller with one of the greatest"
                             " plot twists in cinema history.",
...
anchorman = media.Movie("Anchorman",
                        "Will Ferrell as a TV news anchorman in the"
                        " 1970s, supported by Paul Rudd and Steve"
                        " Carrell.  Enough Said.",
...
a_new_hope = media.Movie("Star Wars",
                         "A futuristic struggle between an evil galactic"
                         " empire and a band of freedom-fighting rebels.",
...
judgement_day = media.Movie("Terminator 2",
                            "A cyborg from the future protects the future"
                            " leader of mankind from another cyborg.",
...
edge_of_tomorrow = media.Movie("Edge of Tomorrow",
                               "A journalist is caught in a time"
                               " loop and must defeat an entire"
                               " invading army himself to save mankind.",
...
avatar = media.Movie("Avatar",
                     "FernGully, but on another planet in the future and in"
                     " 3D.  WARNING: Will make life seem less life-like.",
...
inception = media.Movie("Inception",
                        "A thief who steals corporate secrets via"
...
departed = media.Movie("The Departed",
                       ...
                       " attempt to identify each other while infiltrating"
                       " an Irish gang in South Boston.",
...
toaster = media.Movie("The Brave Little Toaster",
                      "A toaster, a blanket, a lamp, a radio, and a vacuum"
                      " cleaner journey to the city to find their master"
                      " after being abandoned in their cabin in the woods.",
...
movies = [matrix, rush_hour, fellowship_of_the_ring, usual_suspects,
          anchorman, a_new_hope, judgement_day, edge_of_tomorrow,
          avatar, inception, departed, toaster]
